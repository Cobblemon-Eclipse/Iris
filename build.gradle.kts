...
val SODIUM_DEPENDENCY_FABRIC by extra { "maven.modrinth:sodium:24jH02Sf"}
val SODIUM_DEPENDENCY_NEO by extra { "maven.modrinth:sodium:1LjoeVdt"}
...
// https://semver.org/
val MOD_VERSION by extra { "1.9.5" }
