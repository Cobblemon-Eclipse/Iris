...
val MINECRAFT_VERSION by extra { "25w43a" }
val NEOFORGE_VERSION by extra { "21.9.0-alpha.1.21.9-rc1.20250928.195244" }
val FABRIC_LOADER_VERSION by extra { "0.17.3" }
val FABRIC_API_VERSION by extra { "0.135.1+1.21.11" }

val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium").resolve("sodium-fabric-0.7.2-snapshot+mc25w43a-local.jar"))}
