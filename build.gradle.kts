...
val MINECRAFT_VERSION by extra { "25w44a" }
...
val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium").resolve("sodium-fabric-0.7.2-snapshot+mc25w44a-local.jar"))}
