...
val MINECRAFT_VERSION by extra { "25w21a" }
...
val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium").resolve("sodium-fabric-0.6.13-snapshot+mc25w21a-local.jar"))}
